<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="TrackerCompanySetup.aspx.cs" Inherits="FleetMgtSolution.BackOffice.TrackerCompanySetup" %>
...
<div class="row-fluid">
      <span class="span12 label label-info pageheader-text">Setup Tracker Company Page</span>
...
<div class="page-body span10">
  ...
  <div class="inner-header">Setup Tracker Company</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Tracker Company :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Tracker Company</div>
