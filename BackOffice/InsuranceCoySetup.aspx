<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="InsuranceCoySetup.aspx.cs" Inherits="FleetMgtSolution.BackOffice.InsuranceCoySetup" %>
...
<div class="row-fluid">
      <span class="span12 label label-info pageheader-text">Setup Insurance Company Page</span>
...
<div class="page-body span10">
  ...
  <div class="inner-header">Setup Insurance Company</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Insurance Company :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Insurance Company</div>
