<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="FleetLocationLookup.aspx.cs" Inherits="FleetMgtSolution.BackOffice.FleetLocationLookup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row-fluid">
      <span class="span12 label label-info pageheader-text">Manage Fleet Location Page</span>
...
<div class="page-body span10">
  ...
  <div class="inner-header">Setup Fleet Location</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Location :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Fleet Locations</div>
    <asp:HiddenField ID="hid" runat="server" />
    <asp:GridView ID="gvLocation" runat="server" GridLines="None" 
        AutoGenerateColumns="false" CssClass="table table-striped" DataKeyNames="ID" 
          ...
          onselectedindexchanged="ggvLocation_SelectedIndexChanged" 
           onpageindexchanging="gvLocation_PageIndexChanging" 
           onselectedindexchanging="gvLocation_SelectedIndexChanging">
      <Columns>
        <asp:BoundField HeaderText="#" DataField="ID" />
        <asp:BoundField HeaderText="Location" DataField="Name" />
