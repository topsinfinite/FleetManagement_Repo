<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="VehicleTypePage.aspx.cs" Inherits="FleetMgtSolution.BackOffice.VehicleTypePage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  <div class="row-fluid">
      <span class="span12 label label-info pageheader-text">Setup vehicle Type Page</span>
...
<div class="page-body span10">
  ...
  <div class="inner-header">Setup Vehicle Type</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Vehicle Type :</div>
 ...
 <div class="inner-header">List of VehicleMaker</div>
    ...
    <asp:GridView ID="gvVehicleM" runat="server" GridLines="None" 
      ...
      <Columns>
        ...
        <asp:BoundField HeaderText="Vehicle Type" DataField="Name" />
