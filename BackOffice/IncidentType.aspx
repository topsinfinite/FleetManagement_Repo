<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="IncidentType.aspx.cs" Inherits="FleetMgtSolution.BackOffice.IncidentType" %>
...
<div class="row-fluid">
      <span class="span12 label label-info pageheader-text">Setup Incidence Type Page</span>
...
<div class="page-body span10">
  ...
  <div class="inner-header">Setup Incidence Type</div>
    <div class="form-horizontal">
    <div class="nav-header" runat="server" id="dvMsg">Add New Incidence Type :</div>
...
<div class="row-fluid">
 ...
 <div class="inner-header">List of Incidence Type</div>
    ...
    <asp:GridView ID="gvVehicleM" runat="server" GridLines="None" 
      ...
      <Columns>
        ...
        <asp:BoundField HeaderText="Incidence Type" DataField="Name" />
